...
<div class="d-flex">
    <div class="flex-grow-1">
        <h1 class="h2 mb-3 d-inline-block">{{ __('Reports') }}</h1>
    </div>
</div>
                            ...
                            <div class="col text-truncate">
                                <div class="row text-truncate">
                                    <div class="col-12 col-lg-6 d-flex align-items-center text-truncate">
                                        <img src="{{ favicon($report->fullUrl) }}" rel="noreferrer" class="width-4 height-4 {{ (__('lang_dir') == 'rtl' ? 'ml-3' : 'mr-3') }}"> <div class="text-truncate" dir="ltr"><div class="text-truncate" data-tooltip="true" title="{{ $report->url }}"><a href="{{ route('admin.reports.edit', $report->id) }}" dir="ltr">{{ $report->url }}</a></div></div>
                                    </div>

                                    <div class="col-12 col-lg-5 d-flex align-items-center">
                                        @if(isset($report->user))
                                            <div class="d-inline-block {{ (__('lang_dir') == 'rtl' ? 'ml-3' : 'mr-3') }}">
                                                <img src="{{ gravatar(isset($report->user) ? $report->user->email : '', 48) }}" class="rounded-circle width-6 height-6">
                                            </div>
