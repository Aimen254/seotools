...
<div class="card border-0 shadow-sm">
    ...
    <div class="card-body position-relative">
        ...
        <form action="{{ route('tools.css_minifier') }}" method="post" enctype="multipart/form-data" @cannot('tools', ['App\Models\User']) class="position-relative opacity-20 min-height-80" @endcannot>
            ...
            <div class="row mx-n2">
                ...
                <div class="col-auto px-2">
                    <a href="{{ route('tools.css_minifier') }}" class="btn btn-outline-secondary {{ (__('lang_dir') == 'rtl' ? 'mr-auto' : 'ml-auto') }}">{{ __('Reset') }}</a>
                </div>
            </div>
        </form>
