            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-auto">
                    <ul class="nav p-0 mx-n2 mb-3 mb-lg-0 d-flex flex-row">
                        @foreach (['social_facebook' => __('Facebook'), 'social_x' => 'X', 'social_instagram' => 'Instagram', 'social_youtube' => 'YouTube', 'social_linkedin' => 'LinkedIn', 'social_github' => 'GitHub','social_discord' => 'Discord', 'social_reddit' => 'Reddit',  'social_threads' => 'Threads', 'social_tiktok' => 'TikTok', 'social_tumblr' => 'Tumblr', 'social_pinterest' => 'Pinterest',] as $url => $title)
                            @if(config('settings.'.$url))
                                <li class="nav-item d-flex">
                                    <a href="{{ config('settings.'.$url) }}" class="nav-link px-2 py-1 text-secondary text-decoration-none d-flex align-items-center" data-tooltip="true" title="{{ $title }}" rel="nofollow noreferrer noopener">
