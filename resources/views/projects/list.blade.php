        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="d-flex align-items-end">
                    <h1 class="h2 mb-0 flex-grow-1 text-truncate">{{ __('Projects') }}</h1>
                </div>
                                            ...
                                            <div class="col text-truncate">
                                                <div class="row">
                                                    ...
                                                    <div class="d-none d-lg-flex col-lg-2 text-truncate">
                                                        <span class="text-truncate" data-tooltip="true" title="{{ $project->created_at->tz(Auth::user()->timezone ?? config('app.timezone'))->format(__('Y-m-d') . ' H:i:s') }}">{{ $project->created_at->diffForHumans() }}</span>
                                                    </div>
                                                </div>
                                            </div>
