                                            ...
                                            <div class="col text-truncate">
                                                <div class="row">
                                                    ...
                                                    <div class="d-none d-lg-flex col-lg-2 text-truncate">
                                                        <span class="text-truncate" data-tooltip="true" title="{{ $report->generated_at->tz(Auth::user()->timezone ?? config('app.timezone'))->format(__('Y-m-d') . ' H:i:s') }}">{{ $report->generated_at->diffForHumans() }}</span>
                                                    </div>
                                                </div>
                                            </div>
