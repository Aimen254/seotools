...
class User extends Authenticatable implements MustVerifyEmail, hasLocalePreference
{
    ...
    {
        return $this->hasMany('App\Models\Report')->where('user_id', $this->id);
    }
    ...
    public function getReportsCountAttribute()
    {
        ...
        return $this->hasMany('App\Models\Report')->withTrashed()->where('user_id', $this->id)->whereBetween('created_at', [clone($now)->startOfMonth(), clone($now)->endOfMonth()])->count();
    }
}
